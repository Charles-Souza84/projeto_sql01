...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos` (
  ...
  `id_frabricante` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_01_idx` (`id_tipo_produto` ASC) ,
  INDEX `fk_produtos_02_idx` (`id_frabricante` ASC) ,
  CONSTRAINT `fk_produtos_01`
    FOREIGN KEY (`id_tipo_produto`)
    REFERENCES `farmacia`.`tipos_produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produtos_02`
    FOREIGN KEY (`id_frabricante`)
...
CREATE TABLE IF NOT EXISTS `farmacia`.`compras` (
  ...
  `data` DATE NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_compras_01_idx` (`id_cliente` ASC) ,
  CONSTRAINT `fk_compras_01`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos_compra` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_compra_01_idx` (`id_compra` ASC) ,
  INDEX `fk_produtos_compra_02_idx` (`id_produto` ASC) ,
  CONSTRAINT `fk_produtos_compra_01`
    FOREIGN KEY (`id_compra`)
    REFERENCES `farmacia`.`compras` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produtos_compra_02`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`receitas_medica` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_receitas_medicas_01_idx` (`id_produto_compra` ASC) ,
